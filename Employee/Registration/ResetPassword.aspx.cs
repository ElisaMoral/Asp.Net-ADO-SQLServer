        ...
        private void SendPasswordResetEmail(string ToEmail, string UserName, string UniqueId)
{
    ...
    MailMessage mailMessage = new MailMessage("elisamoral1987@gmail.com", ToEmail);
    ...
    sbEmailBody.Append("<br/>");      sbEmailBody.Append("http://localhost/Employee/Registration/ChangePassword.aspx?uid=" + UniqueId);
    ...
    {
        UserName = "elisamoral1987@gmail.com",
        Password = "Eloisa1960"
    };
